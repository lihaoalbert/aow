...
describe "field_groups/new" do
  before(:each) do
    assign(:field_group, stub_model(FieldGroup,
      :name => "MyString",
      :label => "MyString",
      :position => 1,
      :tag_id => 1
  ...
  it "renders new field_group form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => field_groups_path, :method => "post" do
